...
import ReviewsList, { StarRating } from "@/components/features/ReviewsList";
...
export default function ProductDetails() {
  ...
  // Fetch reviews data for rating display
  ...
  return (
    <div className="container py-8 space-y-8 animate-in fade-in duration-500">
      <SEO
        ...
        description={
          data.description ||
          `Shop ${data.name} at KORE. Premium quality ${data.category} product.`
        }
      />
      {/* Breadcrumb */}
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink to={`/shop?category=${data.category}`}>
              {data.category}
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="flex flex-col pb-24 md:pb-0">
          <div className="mb-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mt-4 font-heading leading-tight">
              {data.name}
            </h1>
          ...
          <div className="hidden md:flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <Button
              ...
              className={`px-6 py-7 ${
                isInWishlist(data._id || data.id || "")
                  ? "border-red-200 bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-950/30"
                  : ""
              }`}
              onClick={handleWishlistToggle}
            >
          ...
          <Accordion className="mt-8 space-y-2">
            <AccordionItem title="Description" defaultOpen>
              <div className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground leading-relaxed">
                <p>
                  {data.description ||
                    "Experience premium quality with this meticulously designed product. Crafted for durability and style, it seamlessly integrates into your modern lifestyle."}
                </p>
              </div>
            </AccordionItem>
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p>
                      Free standard shipping on orders over $100. Expected
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p>
                      All products are backed by our 2-year comprehensive
      ...
      <div className="border-t pt-12 mt-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <ReviewsList productId={data._id || data.id || ""} />
          </div>
          <div>
            <ReviewForm productId={data._id || data.id || ""} />
          </div>
        </div>
      </div>
    </div>
